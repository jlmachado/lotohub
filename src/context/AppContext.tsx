 ...
 * Expandido com suporte a Reconhecimento Automático de Placar.
 */
...
interface AppContextType {
  ...
  snookerChannels: SnookerChannel[]; snookerPresence: Record<string, { viewers: string[] }>; snookerFinancialHistory: any[]; snookerBets: any[]; snookerCashOutLog: any[]; snookerLiveConfig: any; snookerActivityFeed: any[]; snookerBetsFeed: any[]; snookerChatMessages: any[]; snookerScoreboards: Record<string, SnookerScoreboard>; snookerSyncLogs: SnookerSyncLog[]; snookerAutomationSettings: SnookerAutomationSettings; celebrationTrigger: boolean;
  ...
  updateSnookerScoreRecognitionSettings: (s: SnookerScoreRecognitionSettings) => void; setSnookerCurrentReading: (r: SnookerScoreReading | null) => void;
