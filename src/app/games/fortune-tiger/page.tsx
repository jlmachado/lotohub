 ...
 * Mantém a rota atual e carrega a implementação real via Iframe para isolamento total.
 */
    ...
    <div className="bg-black min-h-screen flex flex-col items-center overflow-hidden">
        ...
        <div className="w-full h-14 bg-[#1a1a1a] border-b border-yellow-600/20 px-4 flex items-center justify-between z-50">
            ...
            <div className="flex items-center gap-2">
              <span className="text-sm font-black text-yellow-500 uppercase italic tracking-tighter">Fortune Tiger Premium</span>
        ...
        <div id="game-container" className="flex-1 w-full max-w-[500px] relative bg-black shadow-2xl">
            <iframe
                ...
                loading="lazy"
                title="Fortune Tiger Real Clone"
            ></iframe>
        </div>
        
        <div className="w-full py-1 bg-[#0a0a0a] text-center">
